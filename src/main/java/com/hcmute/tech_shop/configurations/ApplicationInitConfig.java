...
public class ApplicationInitConfig {
    ...
    public FileTemplateResolver customTemplateResolver() {
        ...
        templateResolver.setPrefix("/home/adminapp01/zopay/templates/"); // Absolute path or file system location
        templateResolver.setSuffix(".html");
        templateResolver.setTemplateMode("HTML");
        templateResolver.setCharacterEncoding("UTF-8");
        templateResolver.setOrder(1); // Higher priority than the default resolver
